...
const data = [
  ...
  {
    id: "4",
    title: "UEFA Nations League: San Marino Cetak Sejarah Perdana Menang Tandang",
    description: "Vaduz - Tim rangking terbawah FIFA, San Marino, mencetak sejarah di kandang Liechtenstein. La Serenissima untuk pertama kalinya dalam sejarah memenangkan laga tandang.",
    category: "Olahraga",
  ...
  },
  {
    ...
    description: "Scott McTominay tak menyesali keputusannya hengkang dari Manchester United. Ia memilih bergerak maju dan melanjutkan hidup bersama Napoli.",
    category: "Olahraga",
    image: require("../../assets/images/images_berita/mcto.png"),
  },
  {
    id: "6",
    title: "Bek Arab Saudi Ini Tak Takut Intimidasi Suporter Indonesia di SUGBK",
    description: "Laga Indonesia vs Arab Saudi digelar di SUGBK nanti malam. Bek Yasser Al-Shahrani, menegaskan The Green Falcons tak takut intimidasi suporter lawan.",
    category: "Olahraga",
  ...
  },
  {
    ...
    description: "Ilustrasi Apa nama komponen lubang-lubang kecil di sisi prangko? Namanya perforasi.",
    category: "Pengetahuan",
    image: require("../../assets/images/images_berita/prangko.png"), // Gambar URL
  },
  {
    id: "8",
    title: "Cara Dinasti Abbasiyah Mengembangkan Ilmu Pengetahuan",
    description: "Daulah Abbasiyah merupakan khalifah ketiga setelah masa Nabi Muhammad, yang didirikan oleh keturunan dari paman Nabi, yakni Abbas bin Abdul-Muttalib.",
    category: "Pengetahuan",
    image: require("../../assets/images/images_berita/daulah.jpg"), // Gambar URL
  },
  {
    id: "9",
    ...
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/jahe.jpg"), // Gambar URL
  },
  {
    id: "10",
    title: "Apakah Jus Nanas Bisa Menurunkan Kadar Gula? Berikut Penjelasannya",
    description: "Buah nanas memiliki kandungan gula dan karbohidrat alami yang dapat meningkatkan kadar gula darah. Namun, apakah jus nanas bisa menurunkan kadar gula?",
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/nanas.jpg"), // Gambar URL
  },
  {
    id: "11",
    title: "4 Kebiasaan Sederhana yang Bikin Otak Encer, Cegah Pikun di Usia Tua",
    description: "Terdapat sejumlah kebiasaan yang dapat berdampak positif pada kesehatan otak.",
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/otak.png"),
  },
  {
    id: "12",
    title: "Wortel Organik di AS Tercemar E Coli, Picu 1 Warga Tewas-Puluhan Jatuh Sakit",
    description: "Satu orang dilaporkan meninggal dan 39 orang jatuh sakit akibat wabah E coli yang terkait dengan wortel organik.",
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/wortel.png"),
  },
  {
    id: "13",
    title: "Pneumonia pada Anak Bisa Dideteksi dengan Menghitung Napas, Bagaimana Caranya?",
    description: "Orang tua perlu mewaspadai apabila anak mengalami gejala seperti napas cepat. Hal ini dikarenakan napas cepat bisa menjadi salah satu tanda infeksi pneumonia.",
    category: "Kesehatan",
  ...
  },
  {
    ...
    description: "Penasihat Khusus Bidang Kesehatan Presiden Terawan Agus Putranto menyinggung soal pentingnya riset medis untuk memajukan dunia kesehatan Indonesia.",
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/terawan.png"), // Gambar URL
  },
  {
    id: "15",
    title: "Benarkah Kumur Air Garam Bisa Atasi Sariawan?",
    description: "Apakah betul sariawan dapat diobati dengan berkumur air garam, Dok? Atau mungkin ada obat lain untuk mengobati sariawan dan bagaimana mencegah agar sariawan tidak berulang?",
    category: "Kesehatan",
    image: require("../../assets/images/images_berita/garam.png"), // Gambar URL
  },
  {
    id: "16",
    title: "Menteri Desa PDT Dorong Satu Desa Kembangkan Satu Produk Unggulan",
    description: "Menteri Desa PDT mendorong program 'Satu Desa, Satu Produk' untuk memperkuat potensi ekonomi lokal dan mendorong kemandirian desa melalui pengembangan produk unggulan.",
    category: "Politik",
    image: require("../../assets/images/images_berita/desa.png"), // Gambar URL
  },
  {
    id: "17",
    title: "Polda Metro Jaya dan Kejati Jakarta Digugat, Diduga Hentikan Penyidikan Firli Bahuri",
    description: "Polda Metro Jaya dan Kejati Jakarta digugat terkait dugaan penghentian penyidikan kasus Firli Bahuri.",
    category: "Politik",
    image: require("../../assets/images/images_berita/polda.jpg"), // Gambar URL
  },
  {
    id: "18",
    ...
    category: "Politik",
    image: require("../../assets/images/images_berita/sodormic.png"), // Gambar URL
  },
  {
    id: "19",
    title: "4 Ciri Sosiologi sebagai Ilmu Pengetahuan",
    description: "Sosiologi sebagai ilmu pengetahuan memiliki empat ciri utama sebagai ilmu pengetahuan.",
    category: "Pengetahuan",
    image: require("../../assets/images/images_berita/4sosiologi.png"), // Gambar URL
  },
  {
    id: "20",
    title: "Hasil Japan Masters 2024: Gregoria Kalah di Final!",
    description: "Gregoria Mariska Tunjung kalah di final Japan Masters 2024. Gregoria menyerah di hadapan Akane Yamaguchi.",
    category: "Olahraga",
    image: require("../../assets/images/images_berita/gregoria.png"), // Gambar URL
  },
